...
/************************************************************************************************************************/
// Draw the PCA projection of the data using D3.js 
// 
/************************************************************************************************************************/
function drawD3PointCloud(q) {
...
export function drawAll() {
    ...
    const projectedData = pca(data)
    const q = projectedData.map(([v1, v2], i) => ({ x: v1[0], y: v2[0], t: pointCloud[i].t }))
    drawD3PointCloud(q)
}