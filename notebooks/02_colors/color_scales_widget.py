...
MODULE_ALIASES["colorscales"] = "02_colors/colorscales.js"
...
export async function render({ model, el }) {
    ...
    const moduleUri = model.get('colorscales_uri')
    ...
    divElement.style.gridTemplateColumns = '460px'
    const elementId = 'color-scales'
...
class MyClassicD3Widget(anywidget.AnyWidget):
    ...
    colorscales_uri = traitlets.Unicode(
        proj_modules["colorscales"]
    ).tag(sync=True)
    _css = CSS_PATH
    _esm = js_logic