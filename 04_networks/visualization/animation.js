...
export function drawAll(dviElId, url) {
    const parser = new DOMParser()
    const gexfData = parser.parseFromString(url, 'text/xml')
    draw(dviElId, gexfData)
}
...
function draw(divElId, data) {
    ...
    // render
    render(divElId, gexfData)
}
function render(divElId, network) { 
